      ...
      <Card className="border-slate-200">
        ...
        <CardContent className="space-y-3">
          <div className="overflow-x-auto">
            <div className="grid min-w-[720px] grid-cols-[minmax(0,2.4fr)_minmax(0,1.3fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,0.9fr)_minmax(0,1fr)] gap-3 rounded-lg bg-slate-50 px-3 py-2 text-[11px] font-medium text-slate-500">
              <span>Intern</span>
              <span>Date</span>
            ...
            <div className="mt-2 space-y-2 min-w-[720px]">
