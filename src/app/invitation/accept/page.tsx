...
export default function InvitationAcceptPage() {
  ...
  const verifyInvitation = async () => {
    try {
      const response = await apiClient.get<{ success: boolean; data: { user: InvitationData } }>(
        ...
        <Card className="w-full max-w-md border-slate-200">
          <CardContent className="pt-6">
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertTitle className="text-green-900">Account Activated!</AlertTitle>
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <Card className="w-full max-w-md border-slate-200 shadow-lg">
        ...
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Set up your password for <span className="font-medium">{invitationData?.email}</span>
            <br />
